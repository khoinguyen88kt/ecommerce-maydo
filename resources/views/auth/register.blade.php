...
@section('title', 'Đăng Ký | Suit Configurator')
@section('description', 'Đăng ký tài khoản Suit Configurator để thiết kế vest nam may đo theo phong cách riêng của bạn.')

@section('content')
<div class="min-h-[calc(100vh-5rem)] flex items-center justify-center py-12 px-4">
  <div class="w-[420px]" style="width: 450px;">
  {{-- Header --}}
  <div class="mb-8">
      <h1 class="text-2xl font-semibold tracking-tight text-neutral-900">Tạo tài khoản</h1>
  ...
  <form method="POST" action="{{ route('register') }}" class="space-y-6">
      ...
      {{-- Name Field --}}
      <div class="space-y-2">
    <label for="name" class="block text-sm font-medium text-neutral-900">Họ và tên</label>
    <input
          id="name"
          name="name"
          type="text"
    ...
    <p class="text-xs text-neutral-500">Tối thiểu 8 ký tự</p>
      </div>

      {{-- Confirm Password Field --}}
      <div class="space-y-2">
    <label for="password_confirmation" class="block text-sm font-medium text-neutral-900">Xác nhận mật khẩu</label>
  ...
  <div class="mt-6 text-center text-sm">
      <span class="text-neutral-600">Đã có tài khoản?</span>
      <a href="{{ route('login') }}" class="font-medium text-neutral-900 underline underline-offset-4 hover:text-neutral-700">
    Đăng nhập
      </a>
  </div>
  </div>
